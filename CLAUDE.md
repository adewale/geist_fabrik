...
- **src/geistfabrik/**: Complete implementation of all core modules
  - **default_geists/**: Bundled geists (code + Tracery) - automatically available
...
- **Default geists** (src/geistfabrik/default_geists/): Bundled geists that work automatically
...
- ✅ All geists: Pass timeout thresholds on production vaults
