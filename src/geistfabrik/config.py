...
# ----------------------
# These constants control random sampling behavior.

DEFAULT_SAMPLE_SIZE = 5
"""int: Default number of items to return when sampling.

Used by various sampling functions (sample_notes, random_notes, etc.)
...
# ---------------------
# These constants control session behavior and output.

DEFAULT_JOURNAL_DIR = "geist journal"
"""str: Directory name for storing session journal notes.

Session notes are created at <vault>/{DEFAULT_JOURNAL_DIR}/YYYY-MM-DD.md
This directory is automatically created if it doesn't exist.
"""

DEFAULT_SESSION_NOTE_FOOTER = "_Generated by GeistFabrik_"
"""str: Footer text appended to session journal notes.

Simple attribution that appears at the bottom of each session note.
"""


# Cache Configuration
# -------------------
# These constants control caching behavior.

DEFAULT_METADATA_CACHE_SIZE = 1000
"""int: Maximum number of notes to cache metadata for.

Metadata inference can be expensive, so we cache results per note.
When the cache exceeds this size, least-recently-used entries are evicted.
Range: [100, 10000]
Recommended: 1000 (suitable for vaults with up to 1000 notes)
"""
